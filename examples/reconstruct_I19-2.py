...
against a reference reconstruction of the same dataset.
"""
import os, sys, time
import numpy as np
import h5py
...
# ---- compare L=0 HK plane: mine vs the reference rspace3d reconstruction ----
H = vol.H
...
for a, sl, HH, KK, title in [
        ...
        (ax[1], ref_sl, Href, Kref, "reference rspace3d reconstruction")]:
